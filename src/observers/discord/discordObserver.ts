...
import { getDiscordStylePreset } from './discordStyles';
...
export function setupDiscordObserver(
  ...
  const initObserver = () => {
    ...
    handleExistingNodes(discordRoot, config, callbacks, mergedOptions);
    ...
    observer.observe(discordRoot, { childList: true, subtree: true });
...
function createAction({
  ...
  const stylePreset = getDiscordStylePreset(isDarkMode);
