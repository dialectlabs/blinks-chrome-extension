...
import { getNotionStylePreset } from './notionStyles';
...
export function setupNotionObserver(
  ...
  const initObserver = () => {
    ...
    handleExistingNodes(notionRoot, config, callbacks, mergedOptions);
    ...
    observer.observe(notionRoot, { childList: true, subtree: true });
...
function createAction({
  ...
  const stylePreset = getNotionStylePreset(isDarkMode);
